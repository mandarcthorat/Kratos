        ...
        double& rAccumulatedPlasticStrain)
{
    ...
    if( r_constitutive_law_options.Is(ConstitutiveLaw::COMPUTE_STRESS) ||
        ...
        const double delta_k = r_material_properties[EXPONENTIAL_SATURATION_YIELD_STRESS];
                                                             ...
                                                             Matrix &rElasticityTensor)
{
    ...
    const double delta_k = rMaterialProperties[EXPONENTIAL_SATURATION_YIELD_STRESS];
